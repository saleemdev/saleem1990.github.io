...
public class LeaveEntitlements implements java.lang.Runnable {
    ...
    public void LeaveEntitlements(java.sql.Connection connDb, String rqid) {
        ...
        connectDB = connDb;
        transaction = "LEAVE ENTITLEMENTS";
        leaveID = rqid;
...
//                        docPdf.add(table2);
                        ...
                        try {
                            ...
                            PreparedStatement pstV1 = connectDB.prepareStatement("SELECT DISTINCT department FROM secure_password ORDER BY 1");
