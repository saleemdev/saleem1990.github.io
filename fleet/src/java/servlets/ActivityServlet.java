...
public class ActivityServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null) {
            ...
            String user = ConnectionProperties.getUserlogin();
            
           // System.err.println("I just used a session based conn");
           String rank = request.getParameter("rank");

            DashboardMetricsDao.getAndAndPrepareActivitiesJSON(conn, rank);

            String json = activityBeans.getJson();
