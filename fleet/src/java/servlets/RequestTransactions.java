 ...
 * @author owner
 */
@WebServlet(name = "RequestTransactions", urlPatterns = {"/RequestTransactions"})
public class RequestTransactions extends HttpServlet {
     ...
     * @throws IOException if an I/O error occurs
     */
    private void updateRQ(String rqid, String transtype, java.sql.Connection connectDB) {
        String sql = "";
...
//
        ...
        if (transtype.equalsIgnoreCase("DECLINE TRANSPORT")) {
            sql = "UPDATE fleet.transportrequestmemo SET transportconfirm = false WHERE rqid = ?";

            responseText = "TRANSPORT REQUEST DECLINED";

        } else if (transtype.equalsIgnoreCase("DECLINE REQUEST")) {
            sql = "UPDATE fleet.transportrequestmemo SET approved = false WHERE rqid = ?";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        updateRQ(requestid, transtype, conn);
