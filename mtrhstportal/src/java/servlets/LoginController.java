...
import com.mtrh.mtportal.sys.EmailFunctions;
    ...
    public java.sql.Connection connect(String user, String password) {
        ...
        try {
            ...
            if (dbServerIp == null) {
                ...
                dbServerIp = com.mtrh.mtportal.sys.PropertiesFunctions.getpropValue("dbServerIpAdd").toString();
            }

            if (dbPort == null) {
                dbPort = com.mtrh.mtportal.sys.PropertiesFunctions.getpropValue("dbPort").toString();
            }

            if (activeDatabase == null) {
                activeDatabase = com.mtrh.mtportal.sys.PropertiesFunctions.getpropValue("activeDatabase").toString();
            }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (loginid.equalsIgnoreCase("None")) {
            ...
            if (connectDB != null) {
                ...
                EmailFunctions em = new com.mtrh.mtportal.sys.EmailFunctions();
