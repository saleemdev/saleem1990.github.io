                ...
                <div class="row row-offcanvas row-offcanvas-right">
                    ...
                    <nav class="bg-white sidebar sidebar-offcanvas" id="sidebar">
                        ...
                        <ul class="nav">
                            ...
                            <li class="nav-item">
                                <a id="dwkid" class="nav-link" href="basic.jsp">
                                    <img src="images/inventory.png" alt="" width="35" height="35">
                                    <span class="menu-title">Daily Work Ticket</span>
                                </a>
                            </li>
                    ...
                    <div class="content-wrapper">
                        <h3 class="page-heading mb-4">Stuff</h3>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div id ="ticketBodyid" class="modal-body">
                        ...
                        <select class="form-control" id="vehalloc" name="vehalloc">
                                ...
                                <fieldset form="form2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <select class="form-control selectpicker" id="vehreq1Av" name="vehreq1Av" disabled>
                                                <option  value="">- Select -</option> 
                                            </select>
                                        </div>
                                    </div>
