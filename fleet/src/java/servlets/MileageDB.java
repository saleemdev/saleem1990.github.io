...
public class MileageDB extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null) {
            ...
            String sql = "SELECT rqid, vehicle_requested, rqid||'/'||enteredon::date FROM fleet.transportrequestmemo WHERE vehicle_requested = ? and rqid IN (Select refid from fleet.authorizations WHERE stage = 'AUTHORIZE REQUEST')  ORDER BY enteredon desc limit 1;";
