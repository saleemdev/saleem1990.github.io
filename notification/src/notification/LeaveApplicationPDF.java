...
import notification.PDFPAth;
import notification.QRCodeGenerator;
...
public class LeaveApplicationPDF implements java.lang.Runnable {
    ...
    notification.DBObject dbObject;
    ...
    public void RequestPDF(java.sql.Connection connDb, String rqid) {
        ...
        dbObject = new notification.DBObject();
        //   begindate = date1;
        // enddate = date2;
...
//                        docPdf.add(table2);
                        ...
                        date = notification.ServerTime.serverDate(connectDB);                        //  table.addCell("");
                        ...
                        try {
                            ...
                            while (rsetV1.next()) {
                                ...
                                Boolean sent = rsetV1.getBoolean("sent");
                                sentstatus = sent;
                                //applicant details/
...
//HEADER2
                                ...
                                table.getDefaultCell().setColspan(2);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                //phrase = new Phrase("Leave Start: " + leavestart, pfontData);
...
//                                }
                                ...
                                int leaveEntitlement = LeaveFactory.getLeaveEntitleMent(pf, lvtype, connectDB);
                                int leaveAccumulated = LeaveFactory.getLeaveAccumulatedDaysByType(pf, lvtype, connectDB);
...
//                                table.addCell(phrase);
                                ...
                                if (hod) {
                                    ...
                                    table.getDefaultCell().setColspan(1);
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("Leave End: " + leaveEnd, pFontHeader1);
                                    table.addCell(phrase);

                                    table.getDefaultCell().setColspan(2);
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    phrase = new Phrase("To resume: " + resumption, pFontHeader1);
                                    table.addCell(phrase);
                                } else {
...
//                            }
            ...
            if (!sentstatus) {
                emf.SendAttachmentEmailAlerts(ConnectionProperties.getEmail(), "<p>Dear " + ConnectionProperties.getUsername() + "</p><h5>Please find your attached leave application form for your information and further action</h5>", leaveID, connectDB, PDFPAth.getPath2pdf());
            }
            emf.SendAttachmentEmailAlerts("resourcing2@mtrh.go.ke", "<p>Leave Application for " + ConnectionProperties.getUsername() + "</p>", leavetype + "[" + leaveID + "] for " + staffid + " / " + ConnectionProperties.getUsername(), connectDB, PDFPAth.getPath2pdf());
