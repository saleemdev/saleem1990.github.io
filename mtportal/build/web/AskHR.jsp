...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Queries Today</span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span id="ctmhrs" class="info-box-text">Open Queries</span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">My Section</span>
                    ...
                    <div class ="row">
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Ask HR Chat Log</h3>
                                ...
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="myChatsTbl" class="table no-margin">
                                            <thead>
                                                <tr>
                                                    <th></th>
                                                    <th></th>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="myTasks" class="table no-margin">
                                            <thead>
                                                <tr>
                                                    <th></th>
                                                    <th></th>
        ...
        <div class="modal modal-info fade" id="raiseticketmodal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-lg-12 col-xs-12">Expert to handle the issue:<select  id="staffname" class="form-control"  style="width: 100%;">
                                    <option value ="-">-</option>                                                                                       
                                </select></div>
                            <!-- <div class="col-md-3 col-sm-6 col-xs-12">Covering Officer:<input name="cvoffid" id="cvoffid" type="text" class="form-control" placeholder="FirstName/PF"> </div>-->
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="sendticketbtn" class="btn btn-outline">Send ticket</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
        ...
        <div class="modal modal-defsult fade" id="resolvmodal">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button id="closeresolution" type="button" class="btn btn-danger pull-left" data-dismiss="modal">Close</button>

                        <button id="rstickbtn" type="button" class="btn btn-primary">Raise ticket to Expert</button>
                        <button id="closeissueid" type="button" class="btn btn-success">Mark Issue as Resolved</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
