 ...
 * @author owner
 */
@WebServlet(name = "VerifyUserInitially", urlPatterns = {"/VerifyUserInitially"})
public class VerifyUserInitially extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet VerifyUserInitially</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet VerifyUserInitially at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    private String getUserDetails(java.sql.Connection connectDB, String userref, Object transtype) {
        ...
        if (transtype != null && transtype.toString().equalsIgnoreCase("ALL")) {
            ...
            sql = "select  staffid,fullname,designation, email, phone, login_name from secure_password where login_name = ?;";
