...
import static servlets.LoginController.randomAlphaNumeric;
...
public class LogginController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.err.println("My username is " + loginid
        );
        ...
        if (loginid.equalsIgnoreCase("None")) {
            ...
            if (connectDB != null) {
                ...
                //Set the Global connection object <----This was a terrible idea
                ...
                // em.SendEmailAlerts(email, "SECURITY KEY[" + key + "]", "C:\\Users\\owner\\Desktop\banana.jpg", key, connectDB);
                // em.SendOrderEmail(email, "SECURITY KEY[" + key + "]");
                if (tellme(connectDB)) {
