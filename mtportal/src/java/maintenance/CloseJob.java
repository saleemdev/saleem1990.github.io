 ...
 * @author owner
 */
@WebServlet(name = "CloseJob", urlPatterns = {"/CloseJob"})
public class CloseJob extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CloseJob</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CloseJob at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null) {
            ...
            if (transtype.toString().equalsIgnoreCase("close")) {
                sql = "update servicerequest set completed = true where requestid=?";
            }
            if (transtype.toString().equalsIgnoreCase("recall")) {
                sql = "update servicerequest set completed = false where requestid=?";
            }
