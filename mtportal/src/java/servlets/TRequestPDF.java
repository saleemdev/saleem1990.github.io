...
public class TRequestPDF implements java.lang.Runnable {
    ...
    public void TRequestPDF(java.sql.Connection connDb, String rqid, String transtype) {
...
///////////////////////////////////////////////////////////////////////
                        ...
                        try {
                            ...
                            while (rsetV1.next()) {
                                ...
                                String planned_date = rsetV1.getObject(29).toString();
                                String planned_time = rsetV1.getObject(32).toString();
...
////////////////////
                                ...
                                table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase("ORGANIZATION: ", pFontHeader1);
                                table.addCell(phrase);
...
////////////////////
                                ...
                                //table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(organization  , pfontData);
                                table.addCell(phrase);
...
////////////////////
                                ...
                                //table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(idno, pfontData);
                                table.addCell(phrase);
                                ...
                                table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setColspan(4);
                                phrase = new Phrase("TRANSPORT REQUEST DETAILS", pFontHeader);
                                table.addCell(phrase);
                                table.getDefaultCell().setBackgroundColor(java.awt.Color.white);
                                ...
                                table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase("FROM: ", pFontHeader1);
                                table.addCell(phrase);
                                ...
                                //table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(from, pfontData);
                                table.addCell(phrase);
                                table.getDefaultCell().setBackgroundColor(java.awt.Color.white);
                                ...
                                table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase("DESTINATION: ", pFontHeader1);
                                table.addCell(phrase);

                                table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(destination, pfontData);
                                table.addCell(phrase);
                                table.getDefaultCell().setBackgroundColor(java.awt.Color.white);
...
//                                table.getDefaultCell().setBorder(Rectangle.BOX);
//                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
//                                phrase = new Phrase("NO OF PASSENGERS: ", pFontHeader1);
//                                table.addCell(phrase);
//
//                                table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
//                                table.getDefaultCell().setColspan(1);
//                                //table.getDefaultCell().setBorder(Rectangle.BOX);
//                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
//                                phrase = new Phrase(paxno.replace(".00", ""), pfontData);
//                                table.addCell(phrase);
//                                table.getDefaultCell().setBackgroundColor(java.awt.Color.white);
//
//                                table.getDefaultCell().setBackgroundColor(java.awt.Color.white);
...
//                                table.getDefaultCell().setBorder(Rectangle.BOX);
//                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
//                                phrase = new Phrase("DISTANCE(Km): ", pFontHeader1);
//                                table.addCell(phrase);
//
//                                table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
//                                table.getDefaultCell().setColspan(1);
//                                //table.getDefaultCell().setBorder(Rectangle.BOX);
//                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
//                                phrase = new Phrase(distance, pfontData);
//                                table.addCell(phrase);
//                                table.getDefaultCell().setBackgroundColor(java.awt.Color.white);
                                table.getDefaultCell().setBackgroundColor(java.awt.Color.white);
                                table.getDefaultCell().setColspan(1);
                                table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase("PURPOSE OF FLEET REQUEST: ", pFontHeader1);
                                table.addCell(phrase);
                                ...
                                table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase("ESTIMATED DEPARTURE TIME: ", pFontHeader1);
                                table.addCell(phrase);

                                table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
                                table.getDefaultCell().setColspan(3);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(LeaveFactory.getFormattedDate(connectDB, planned_date)+" AT "+planned_time, pfontData);
                                table.addCell(phrase);
                                ...
                                table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setColspan(4);
                                phrase = new Phrase("FLEET REQUEST INFORMATION", pFontHeader);
                                table.addCell(phrase);
                                table.getDefaultCell().setBackgroundColor(java.awt.Color.white);
                                ...
                                table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase("VEHICLE TYPE REQUESTED: ", pFontHeader1);
                                table.addCell(phrase);
...
//                                table.getDefaultCell().setBorder(Rectangle.BOX);
//                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
//                                phrase = new Phrase("VEHICLE ALLOCATED: ", pFontHeader1);
//                                table.addCell(phrase);
//
//                                table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
//                                table.getDefaultCell().setColspan(3);
//                                //table.getDefaultCell().setBorder(Rectangle.BOX);
//                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
//                                phrase = new Phrase(vehissued + "-" + driver, pfontData);
//                                table.addCell(phrase);
//                                table.getDefaultCell().setBackgroundColor(java.awt.Color.white);
                                table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
                                table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setColspan(4);
                                phrase = new Phrase("FLEET MANIFEST", pFontHeader);
                                table.addCell(phrase);
                                table.getDefaultCell().setBackgroundColor(java.awt.Color.white);
                                ...
                                //fLEET MANIFEST STARTS HERE
                                PreparedStatement pst = connectDB.prepareStatement("SELECT  fullname, idno, contactinfo \n"
                                        + "  FROM fleet.manifest WHERE refid = '" + request + "' ;");
                                ...
                                while (rset.next()) {
                                    ...
                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    table.getDefaultCell().setColspan(2);
                                    phrase = new Phrase(j + ". " + rset.getObject(1).toString().toUpperCase(), pfontData);
                                    table.addCell(phrase);
                                    table.getDefaultCell().setBackgroundColor(java.awt.Color.white);

                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    table.getDefaultCell().setColspan(1);
                                    phrase = new Phrase(rset.getObject(2).toString().toUpperCase(), pfontData);
                                    table.addCell(phrase);
                                    table.getDefaultCell().setBackgroundColor(java.awt.Color.white);

                                    table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                    table.getDefaultCell().setColspan(1);
                                    phrase = new Phrase(rset.getObject(3).toString().toUpperCase(), pfontData);
                                    table.addCell(phrase);
                                    table.getDefaultCell().setBackgroundColor(java.awt.Color.white);
                                    j += 1;

                                }
                                //fLEET MANIFEST ENDS HERE
