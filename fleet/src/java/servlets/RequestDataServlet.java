...
public class RequestDataServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        java.sql.Connection conn = ls.connect("postgres", "sequence");

        if (transtype.equalsIgnoreCase("insert")) {
            String fullname = request.getParameter("fullname");//1
            String idno = request.getParameter("refno");//2
            String email = request.getParameter("emailid");//3
            String telno = request.getParameter("telno");//4
            String rqtype = request.getParameter("rqtype");//5

            DBObject dbobj = new DBObject();
            String orgname = dbobj.getDBObject(request.getParameter("organization"), "");//6
            String dept = dbobj.getDBObject(request.getParameter("dept"), "");//7
            ...
            String remarks = dbobj.getDBObject(request.getParameter("remarks"), "");//14
            ...
            Object[] items = new Object[]{fullname, idno, email, telno, rqtype, orgname, dept, from, destination, distance, pax, vehrequested, purpose, remarks, enteredby};
        ...
        if (transtype.equalsIgnoreCase("insertinvoice")) {
        ...
        if (transtype.equalsIgnoreCase("fuel")) {
            ...
            String driverref = request.getParameter("driverref");
            ...
            Object[] items = new Object[]{refno, cardno, driverref, vehreg, quantity, fueltype, amount, comments};
    ...
    private void insertMtceReq(Object[] obj, java.sql.Connection connectDB) {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(RequestDataServlet.class.getName()).log(Level.SEVERE, null, ex1);
            }
            ex.printStackTrace();
        }
    ...
    private void insertFuelReq(Object[] obj, java.sql.Connection connectDB) {
        ...
        String email = upf.getEmail();
        String staffid = upf.getRefid();
        String designation = upf.getDesignation();
        String fullname = upf.getFullname();
        String username = upf.getUsername();
        String phone = upf.getPhone();
        //{Done for now...}
        ...
        try {
            ...
            Object[] mailing = new Object[]{email};
            CommunicationList comm = new CommunicationList();
            comm.setCommunicationList(refno, mailing, connectDB);
    ...
    private void insertData(java.sql.Connection connectDB, Object[] obj, String refno) {
        String sql = "INSERT INTO fleet.transportrequestmemo(\n"
                + "            rqid, rqtype, requestedby, idno, email, telno, organization, \n"
                + "            department, from_, destination, distance, pax_no, vehicle_requested, \n"
                + "            purpose, remarks,  enteredby)\n"
                + "    VALUES (?, ?, ?, ?, ?, ?, ?, \n"
                + "            ?, ?, ?, ?::numeric, ?::numeric, ?, \n"
                + "            ?, ?, ?);";
        ...
        try {
            ...
            //-------------
            pst.setObject(13, obj[11]);
            pst.setObject(14, obj[12]);
            pst.setObject(15, obj[13]);
            //------------ 
            pst.setObject(16, obj[14]);
