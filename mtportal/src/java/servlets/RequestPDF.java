...
////////////////////
                                ...
                                table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase("ORGANIZATION/DEPT: ", pFontHeader1);
                                table.addCell(phrase);
...
////////////////////
                                ...
                                //table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(organization + "/" + department, pfontData);
                                table.addCell(phrase);
                                ...
                                table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase("DATA ENTRY DETAILS: ", pFontHeader1);
                                table.addCell(phrase);
...
////////////////////
                                ...
                                //table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(enteredby + " @ " + enteredon, pfontData);
                                table.addCell(phrase);
                                ...
                                table.getDefaultCell().setBorder(Rectangle.BOX);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_RIGHT);
                                phrase = new Phrase("REMARKS/COMMENTS: ", pFontHeader1);
                                table.addCell(phrase);

                                table.getDefaultCell().setBackgroundColor(java.awt.Color.LIGHT_GRAY);
                                table.getDefaultCell().setColspan(3);
                                table.getDefaultCell().setHorizontalAlignment(PdfCell.ALIGN_LEFT);
                                phrase = new Phrase(remarks + "\n" + purpose, pfontData);
                                table.addCell(phrase);
                                table.getDefaultCell().setBackgroundColor(java.awt.Color.white);
                                table.getDefaultCell().setBackgroundColor(java.awt.Color.white);
